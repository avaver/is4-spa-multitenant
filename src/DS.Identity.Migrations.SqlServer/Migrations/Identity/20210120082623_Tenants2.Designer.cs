...
namespace DS.Identity.Migrations.SqlServer.Migrations.Identity
{
    ...
    [Migration("20210120082623_Tenants2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DS.Identity.Multitenancy.Tenant", b =>
                {
                    b.HasOne("DS.Identity.Multitenancy.WebAuthnCredential", "AdminKey")
                        .WithMany()
                        .HasForeignKey("AdminKeyId");

                    b.Navigation("AdminKey");
                });
